...
var _user$project$FcTypes$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$FcTypes$FcShape = F6(
	function (a, b, c, d, e, f) {
		return {id: a, shapeType: b, x: c, y: d, text: e, title: f};
	});
var _user$project$FcTypes$FcArrow = F4(
	function (a, b, c, d) {
...
var _user$project$FcTypes$TitleChanged = function (a) {
	return {ctor: 'TitleChanged', _0: a};
};
var _user$project$FcTypes$HttpFailure = function (a) {
	return {ctor: 'HttpFailure', _0: a};
};
var _user$project$FcTypes$HttpSuccess = function (a) {
	return {ctor: 'HttpSuccess', _0: a};
};
var _user$project$FcTypes$UpMsg = function (a) {
	return {ctor: 'UpMsg', _0: a};
};
var _user$project$FcTypes$DownMsg = function (a) {
	return {ctor: 'DownMsg', _0: a};
};
var _user$project$FcTypes$KeyMsg = function (a) {
	return {ctor: 'KeyMsg', _0: a};
};
var _user$project$FcTypes$MouseMove = function (a) {
	return {ctor: 'MouseMove', _0: a};
};
var _user$project$FcTypes$MouseUp = function (a) {
	return {ctor: 'MouseUp', _0: a};
};
var _user$project$FcTypes$MouseDown = function (a) {
...
var _user$project$FcElement$findFreeId = function (l) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (el, state) {
...
var _user$project$FcElement$arrowsWithEndShape = F2(
	function (model, id) {
		return A2(
...
var _user$project$FcElement$arrowsWithStartShape = F2(
	function (model, id) {
		return A2(
			_elm_lang$core$List$filter,
			function (x) {
...
var _user$project$FcElement$getArrowWithId = F2(
	function (model, id) {
...
var _user$project$FcElement$getShapeWithId = F2(
	function (model, id) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
...
var _user$project$FcElement$getElementWithId = F2(
	function (model, fcElementId) {
		var _p6 = fcElementId;
		if (_p6.ctor === 'FcShapeId') {
			return A2(
				_elm_lang$core$Maybe$map,
				function (sh) {
					return _user$project$FcTypes$ShapeElement(sh);
				},
				A2(_user$project$FcElement$getShapeWithId, model, _p6._0));
		} else {
			return A2(
				_elm_lang$core$Maybe$map,
				function (ar) {
					return _user$project$FcTypes$ArrowElement(ar);
				},
				A2(_user$project$FcElement$getArrowWithId, model, _p6._0));
		}
	});
var _user$project$FcElement$removeElement = F2(
	function (model, fcElementId) {
		var _p7 = fcElementId;
		if (_p7.ctor === 'FcShapeId') {
			var _p10 = _p7._0;
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					fcShapes: A2(
						_elm_lang$core$List$filter,
						function (sh) {
							return !_elm_lang$core$Native_Utils.eq(sh.id, _p10);
						},
						model.fcShapes),
					fcArrows: A2(
						_elm_lang$core$List$map,
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					fcArrows: A2(
						_elm_lang$core$List$filter,
						function (sh) {
							return !_elm_lang$core$Native_Utils.eq(sh.id, _p7._0);
						},
						model.fcArrows)
				});
		}
...
var _user$project$FcDatabase$saveElements = function (model) {
	var toArrowObject = function (a) {
		...
		var destination_offset_x = _p0._1;
		...
		var source_offset_x = _p2._1;
		var source_offset_y = _p2._2;
	...
	var toShapeObject = function (s) {
		var _p4 = A2(_elm_lang$core$Debug$log, 's', s);
		return _elm_lang$core$Json_Encode$object(
			_elm_lang$core$Native_List.fromArray(
				[
					{
...
var _user$project$FcDatabase$decodeElements = function () {
	...
	var toFcShape = A7(
		...
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'shapeType',
			A2(_elm_lang$core$Json_Decode$object1, _user$project$FcDatabase$readShapeType, _elm_lang$core$Json_Decode$string)),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'title',
			_elm_lang$core$Json_Decode$oneOf(
...
var _user$project$FcDatabaseTest$fcDatabaseTests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'FcDatabaseTest',
	_elm_lang$core$Native_List.fromArray(
		[]));

var _user$project$FcElementTest$setup = {
	fcShapes: _elm_lang$core$Native_List.fromArray(
		[
			{id: 1, shapeType: _user$project$FcTypes$Start, x: 0.0, y: 0.0, text: 'text', title: 'title'},
			{id: 2, shapeType: _user$project$FcTypes$Start, x: 30.0, y: 40.0, text: 'text', title: 'title'},
			{id: 3, shapeType: _user$project$FcTypes$Start, x: 0.0, y: 0.0, text: 'text', title: 'title'},
			{id: 4, shapeType: _user$project$FcTypes$Start, x: 0.0, y: 0.0, text: 'text', title: 'title'},
			{id: 5, shapeType: _user$project$FcTypes$Start, x: 0.0, y: 0.0, text: 'text', title: 'title'}
		]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						'getShapeWithId_NonexistentId_ReturnsNothing',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Maybe$Nothing,
							A2(_user$project$FcElement$getShapeWithId, model, 12))),
						A2(
						_elm_community$elm_test$ElmTest$test,
						'getShapeWithId_ExistingShape_ReturnsShape',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Maybe$Just(
								{id: 1, shapeType: _user$project$FcTypes$Start, x: 0.0, y: 0.0, text: 'text', title: 'title'}),
							A2(_user$project$FcElement$getShapeWithId, model, 1)))
					])),
				A2(
				_elm_community$elm_test$ElmTest$suite,
				'getArrowWithId',
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_community$elm_test$ElmTest$test,
						'getArrowWithId_NonexistentArrow_ReturnsNothing',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Maybe$Nothing,
							A2(_user$project$FcElement$getArrowWithId, model, 12))),
						A2(
						_elm_community$elm_test$ElmTest$test,
						'getArrowWithId_ExistingArrow_ReturnsArrow',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Maybe$Just(
								{
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_community$elm_test$ElmTest$test,
						'getElementWithId_NonexistentShapeElement_ReturnsNothing',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Maybe$Nothing,
							A2(
								_user$project$FcElement$getElementWithId,
								model,
								_user$project$FcTypes$FcShapeId(12)))),
						A2(
						_elm_community$elm_test$ElmTest$test,
						'getElementWithId_ExistingShapeElement_ReturnsShapeElement',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Maybe$Just(
								_user$project$FcTypes$ShapeElement(
									{id: 1, shapeType: _user$project$FcTypes$Start, x: 0.0, y: 0.0, text: 'text', title: 'title'})),
							A2(
								_user$project$FcElement$getElementWithId,
								model,
						...
						A2(
						_elm_community$elm_test$ElmTest$test,
						'getElementWithId_NonexistentArrowElement_ReturnsNothing',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Maybe$Nothing,
							A2(
								_user$project$FcElement$getElementWithId,
								model,
								_user$project$FcTypes$FcArrowId(12)))),
						A2(
						_elm_community$elm_test$ElmTest$test,
						'getElementWithId_ExistingArrowElement_ReturnsArrowElement',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Maybe$Just(
							...
							A2(
								_user$project$FcElement$getElementWithId,
								model,
								_user$project$FcTypes$FcArrowId(1))))
					])),
				A2(
				_elm_community$elm_test$ElmTest$suite,
				'getStartShapeId',
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_community$elm_test$ElmTest$test,
						'getStartShapeId_OffsetArrow_ReturnsId',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_community$elm_test$ElmTest$test,
						'getEndShapeId_OffsetArrow_ReturnsId',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
				...
				A2(
				_elm_community$elm_test$ElmTest$suite,
				'arrowsWithStartShape',
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_community$elm_test$ElmTest$test,
						'arrowsWithStartShape_NonexistentId_ReturnsEmptyList',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Native_List.fromArray(
								[]),
							A2(_user$project$FcElement$arrowsWithStartShape, model, 122))),
						A2(
						_elm_community$elm_test$ElmTest$test,
						'arrowsWithStartShape_ExistentId_ReturnsArrowList',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Native_List.fromArray(
								[
							...
							A2(_user$project$FcElement$arrowsWithStartShape, model, 1)))
					])),
				A2(
				_elm_community$elm_test$ElmTest$suite,
				'arrowsWithEndShape',
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_community$elm_test$ElmTest$test,
						'arrowsWithEndShape_NonexistentId_ReturnsEmptyList',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Native_List.fromArray(
								[]),
							A2(_user$project$FcElement$arrowsWithEndShape, model, 122))),
						A2(
						_elm_community$elm_test$ElmTest$test,
						'arrowsWithEndShape_ExistentId_ReturnsArrowList',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_elm_lang$core$Native_List.fromArray(
								[
							...
							A2(_user$project$FcElement$arrowsWithEndShape, model, 3)))
					])),
				A2(
				_elm_community$elm_test$ElmTest$suite,
				'findFreeId',
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							_user$project$FcElement$findFreeId(
								_elm_lang$core$Native_List.fromArray(
									[])),
							1)),
						A2(
						_elm_community$elm_test$ElmTest$test,
						'findFreeId_NonEmptyList_ReturnsNextId',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							6,
							_user$project$FcElement$findFreeId(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_community$elm_test$ElmTest$test,
						'removeElement_NonExistentShapeId_ReturnsSameModel',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							model,
							A2(
								...
								model,
								_user$project$FcTypes$FcShapeId(89)))),
						A2(
						_elm_community$elm_test$ElmTest$test,
						'removeElement_NonExistentArrowId_ReturnsSameModel',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							A2(
								_user$project$FcElement$removeElement,
								model,
								_user$project$FcTypes$FcArrowId(89)),
							model)),
						A2(
						_elm_community$elm_test$ElmTest$test,
						'removeElement_ExistingShapeId_ReturnsUpdatedModel',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							{
								fcShapes: _elm_lang$core$Native_List.fromArray(
							...
							A2(
								_user$project$FcElement$removeElement,
								model,
								_user$project$FcTypes$FcShapeId(2)))),
						A2(
						_elm_community$elm_test$ElmTest$test,
						'removeElement_ExistingArrowId_ReturnsUpdatedModel',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							{
								fcShapes: _elm_lang$core$Native_List.fromArray(
							...
							A2(
								_user$project$FcElement$removeElement,
								model,
								_user$project$FcTypes$FcArrowId(2))))
					])),
				A2(
				_elm_community$elm_test$ElmTest$suite,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_community$elm_test$ElmTest$test,
						'doesPositionShareElements_UnsharedOffsetPositions_ReturnsFalse',
						A2(
							_elm_community$elm_test$ElmTest$assertEqual,
							false,
							A2(
...
var _user$project$Tests$tests = A2(
	...
	'All Tests',
	_elm_lang$core$Native_List.fromArray(
		[_user$project$FcElementTest$fcElementTests, _user$project$FcDatabaseTest$fcDatabaseTests]));
var _user$project$Tests$getTestResults = _elm_community$elm_test$ElmTest$stringRunner(_user$project$Tests$tests);

var _user$project$FcGraphics$getTextDimension = F3(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							(_elm_lang$core$Native_Utils.cmp(endX, startX) > 0) ? _elm_lang$svg$Svg_Attributes$d(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'M ',
								A2(
															...
															A2(
																...
																A2(
																	...
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		', ',
																		_elm_lang$core$Basics$toString(endY))))))))))))) : _elm_lang$svg$Svg_Attributes$d(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'M ',
								A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							_elm_lang$core$Json_Decode$map,
							function (keyCode) {
								return _user$project$FcTypes$KeyMsg(keyCode);
							},
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$value(_user$project$Tests$getTestResults),
										_elm_lang$html$Html_Attributes$style(
										_elm_lang$core$Native_List.fromArray(
											[
												{ctor: '_Tuple2', _0: 'width', _1: '100%'},
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$List$map,
									_user$project$FcGraphics$fcShapeToSvg(model),
									model.fcShapes),
								A2(
									_elm_lang$core$Basics_ops['++'],
									A2(
										_elm_lang$core$List$map,
										_user$project$FcGraphics$fcArrowToSvg(model),
										model.fcArrows),
									cur))))
					])),
				A2(
	...
	function (msg, model) {
		...
		switch (_p2.ctor) {
			...
			case 'MouseDown':
				...
				var shapePos = A2(
					_elm_lang$core$Maybe$map,
					_user$project$FcElement$getShapeWithId(model),
					id);
				var pos = A2(
			...
			case 'UpMsg':
				var _p29 = _p2._0;
				var _p25 = A2(_elm_lang$core$Debug$log, 'id ist..................................', _p29);
				var _p26 = _p29;
				switch (_p26.ctor) {
					case 'ArrowStart':
						return A2(
					...
					case 'ArrowMiddle':
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[]));
					case 'Inner':
						var _p27 = A2(_elm_lang$core$Debug$log, 'upMsg currentLine', 'hallo');
						var newCurrentLine = A2(
							...
							function (l) {
								return {
									...
									_1: {
										ctor: '_Tuple3',
										_0: _elm_lang$core$Maybe$Just(_p26._0),
										_1: 0,
										_2: 0
									}
								};
						...
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[]));
					default:
						var _p28 = A2(_elm_lang$core$Debug$log, 'upMsg currentLine', 'hallo');
						var newCurrentLine = A2(
							_elm_lang$core$Maybe$map,
							function (l) {
								return {
			...
			case 'MouseUp':
				var _p38 = _p2._0;
				var _p30 = A2(_elm_lang$core$Debug$log, 'mouseup ', model.currentLine);
				var arrow = A2(
					_elm_lang$core$Maybe$map,
					function (l) {
						return {
				...
				var h = function () {
					...
					if (_p31.ctor === 'Nothing') {
						...
						if ((_p32.ctor === '_Tuple3') && (_p32._0.ctor === 'Just')) {
							var _p36 = _p32._0._0;
							var elid = _user$project$FcElement$findFreeId(model.fcArrows);
							var element = A2(_user$project$FcElement$getShapeWithId, model, _p36);
							var _p33 = function () {
								var _p34 = element;
							...
							var offsetX = _p33._0;
							var offsetY = _p33._1;
							return A2(_user$project$FcElement$doesPositionShareElements, _p37.startPos, _p37.endPos) ? _elm_lang$core$Native_List.fromArray(
								[]) : _elm_lang$core$Native_List.fromArray(
								[
									{
									id: elid,
									...
									endPos: {
										ctor: '_Tuple3',
										_0: _elm_lang$core$Maybe$Just(_p36),
										_1: offsetX,
										_2: offsetY
									},
			...
			case 'MouseMove':
				...
				var pos = A2(
					_user$project$Main$localToGlobal,
					{
						x: _elm_lang$core$Basics$toFloat(_p44.x),
						y: _elm_lang$core$Basics$toFloat(_p44.y)
					},
					model.mainDivOffset);
						...
						case 'Inner':
							...
							return A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[]));
						case 'Outer':
							var element = A2(_user$project$FcElement$getShapeWithId, model, _p40._0);
							var m = function () {
								var _p41 = element;
