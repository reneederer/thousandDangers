	...
	function (pos1, pos2) {
		...
		if ((_p1.ctor === 'Offset') && (_p1._0.ctor === '_Tuple3')) {
			...
			if ((_p2.ctor === 'Offset') && (_p2._0.ctor === '_Tuple3')) {
				return _elm_lang$core$Native_Utils.eq(_p1._0._0, _p2._0._0);
			} else {
				return false;
			}
		} else {
	...
	function (model, movingElement, x, y) {
		...
		if (_p3.ctor === 'Nothing') {
			...
			var newShapes = A2(
				_elm_lang$core$List$map,
				function (el) {
					return _elm_lang$core$Native_Utils.eq(el.id, _p4) ? _elm_lang$core$Native_Utils.update(
						el,
						{x: x, y: y}) : el;
				},
				model.fcShapes);
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					debugMsg: _elm_lang$core$Basics$toString(_p4),
					fcShapes: newShapes
				});
		}
	});
var _user$project$Main$removeElement = F2(
	function (model, id) {
		var newArrows = A3(
			_elm_lang$core$List$foldr,
			F2(
				function (el, state) {
					return _elm_lang$core$Native_Utils.eq(el.id, id) ? state : A2(_elm_lang$core$List_ops['::'], el, state);
				}),
			_elm_lang$core$Native_List.fromArray(
				[]),
			model.fcArrows);
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{fcShapes: newShapes, fcArrows: newArrows});
	});
var _user$project$Main$findFreeId = function (model) {
	var minShapes = A3(
		_elm_lang$core$List$foldl,
		F2(
			function (el, state) {
...
var _user$project$Main$getElementWithId = F2(
	function (model, id) {
	...
	function (model, _p5) {
		...
		var _p7 = function () {
			...
			if (_p8.ctor === 'Global') {
				...
				var el = A2(_user$project$Main$getElementWithId, model, _p8._0._0);
				var _p9 = el;
				if (_p9.ctor === 'Nothing') {
		...
		var endY = _p7._1;
		var _p11 = function () {
			var _p12 = _p6.startPos;
			if (_p12.ctor === 'Global') {
				return {ctor: '_Tuple2', _0: _p12._0._0, _1: _p12._0._1};
			} else {
				var el = A2(_user$project$Main$getElementWithId, model, _p12._0._0);
				var _p13 = el;
				if (_p13.ctor === 'Nothing') {
					return {ctor: '_Tuple2', _0: 0, _1: 0};
				} else {
					var _p14 = _p13._0;
					return {ctor: '_Tuple2', _0: _p12._0._1 + _p14.x, _1: _p12._0._2 + _p14.y};
				}
			}
		}();
		var startX = _p11._0;
...
var _user$project$Main$options = {preventDefault: true, stopPropagation: false};
...
var _user$project$Main$FcArrow = F4(
	function (a, b, c, d) {
...
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {fcShapes: a, fcArrows: b, debugMsg: c, dragElement: d, dragOffsetX: e, dragOffsetY: f, selectedElement: g, currentLine: h};
	});
var _user$project$Main$Action = {ctor: 'Action'};
var _user$project$Main$Condition = {ctor: 'Condition'};
var _user$project$Main$createConditionElement = F3(
	function (id, x, y) {
		return {id: id, shapeType: _user$project$Main$Condition, x: x, y: y, text: 'Condition', title: 'Mein Titel'};
	});
var _user$project$Main$End = {ctor: 'End'};
var _user$project$Main$createEndElement = F3(
	function (id, x, y) {
		return {id: id, shapeType: _user$project$Main$End, x: x, y: y, text: 'Ende', title: 'Ende'};
	});
var _user$project$Main$Start = {ctor: 'Start'};
var _user$project$Main$createStartElement = F3(
	function (id, x, y) {
		return {id: id, shapeType: _user$project$Main$Start, x: x, y: y, text: 'Start', title: 'Start'};
	});
...
var _user$project$Main$init = {
	...
	_0: {
		fcShapes: _elm_lang$core$Native_List.fromArray(
			[
				{id: 1, shapeType: _user$project$Main$Start, x: 40, y: 90, text: '', title: 'Start'},
				{id: 2, shapeType: _user$project$Main$Action, x: 40, y: 490, text: '', title: 'Action'},
				{id: 3, shapeType: _user$project$Main$End, x: 150, y: 290, text: '', title: 'End'}
			]),
...
var _user$project$Main$places = function () {
	var toFcArrow = A8(
		...
		F7(
			function (source_id, destination_id, source_offset_x, source_offset_y, destination_offset_x, destination_offset_y, title) {
				return {
					id: 789,
					startPos: _user$project$Main$Offset(
						{ctor: '_Tuple3', _0: source_id, _1: source_offset_x, _2: source_offset_y}),
					endPos: _user$project$Main$Offset(
						{ctor: '_Tuple3', _0: destination_id, _1: destination_offset_x, _2: destination_offset_y}),
					title: title
				};
			}),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'source_id', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'destination_id', _elm_lang$core$Json_Decode$int),
...
var _user$project$Main$lookupZipCode = function () {
	var s = A2(_evancz$elm_http$Http$get, _user$project$Main$places, 'http://localhost/elm/thousandDangers/src/db.php');
	return s;
}();
var _user$project$Main$ArrowElement = function (a) {
	return {ctor: 'ArrowElement', _0: a};
};
var _user$project$Main$ShapeElement = function (a) {
	...
	function (msg, model) {
		...
		switch (_p16.ctor) {
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								dragElement: _elm_lang$core$Maybe$Just(
									{areaType: _p18, id: _p19}),
								selectedElement: _p19,
								currentLine: _elm_lang$core$Maybe$Nothing
							}),
						_elm_lang$core$Native_List.fromArray(
							[]));
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								...
								currentLine: _elm_lang$core$Maybe$Just(
									{
										ctor: '_Tuple2',
										_0: _user$project$Main$Offset(
											{ctor: '_Tuple3', _0: _p19, _1: 0, _2: 0}),
										_1: _user$project$Main$Offset(
											{ctor: '_Tuple3', _0: _p19, _1: 0, _2: 0})
									})
							}),
						_elm_lang$core$Native_List.fromArray(
			...
			case 'MouseDown':
				var _p28 = _p16._0;
				var id = function () {
					var _p20 = model.dragElement;
					if (_p20.ctor === 'Nothing') {
						return _elm_lang$core$Maybe$Nothing;
					} else {
						return _elm_lang$core$Maybe$Just(_p20._0.id);
					}
				}();
				var shapePos = A2(
					_elm_lang$core$Maybe$map,
					_user$project$Main$getElementWithId(model),
					id);
				var _p21 = shapePos;
				if ((_p21.ctor === 'Just') && (_p21._0.ctor === 'Just')) {
					var _p27 = _p21._0._0;
					var offsetY = _elm_lang$core$Basics$toFloat(_p28.y) - _p27.y;
					var offsetX = _elm_lang$core$Basics$toFloat(_p28.x) - _p27.x;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								...
								currentLine: A2(
									...
									function (_p22) {
										...
										var _p26 = _p23._0;
										var _p24 = _p26;
										if ((_p24.ctor === 'Offset') && (_p24._0.ctor === '_Tuple3')) {
											var _p25 = _p24._0._0;
											return {
												ctor: '_Tuple2',
												_0: _user$project$Main$Offset(
													{ctor: '_Tuple3', _0: _p25, _1: offsetX, _2: offsetY}),
												_1: _user$project$Main$Offset(
													{ctor: '_Tuple3', _0: _p25, _1: offsetX, _2: offsetY})
											};
										} else {
											return {ctor: '_Tuple2', _0: _p26, _1: _p23._1};
										}
									},
									model.currentLine)
							}),
					...
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A2(_elm_lang$core$Debug$log, 'soll das so sein?', model),
						_elm_lang$core$Native_List.fromArray(
							[]));
				}
			case 'KeyMsg':
				...
				switch (_p29) {
								...
								model,
								{
									...
									fcShapes: A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												A3(
												_user$project$Main$createStartElement,
												_user$project$Main$findFreeId(model),
												400.0,
												400.0)
											]))
								}),
					...
					case 98:
						var x = A3(
							...
							_user$project$Main$lookupZipCode);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
					...
					case 127:
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							A2(_user$project$Main$removeElement, model, model.selectedElement),
							_elm_lang$core$Native_List.fromArray(
								[]));
					default:
						return A2(
			...
			case 'HttpSuccess':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							fcShapes: _elm_lang$core$Basics$fst(_p30),
							fcArrows: _elm_lang$core$Basics$snd(_p30)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'HttpFailure':
							...
							currentLine: A2(
								...
								function (l) {
									return {
										...
										_1: _user$project$Main$Offset(
											{ctor: '_Tuple3', _0: _p16._0.id, _1: 0, _2: 0})
									};
								},
								model.currentLine)
						}),
			...
			case 'MouseUp':
				...
				var arrow = A2(
					...
					function (l) {
						return {
							id: _user$project$Main$findFreeId(model),
				...
				var h = function () {
					...
					if (_p31.ctor === 'Nothing') {
						...
						var _p37 = _p31._0;
						var _p32 = _p37.endPos;
						if ((_p32.ctor === 'Offset') && (_p32._0.ctor === '_Tuple3')) {
							var _p36 = _p32._0._0;
							var element = A2(_user$project$Main$getElementWithId, model, _p36);
							var _p33 = function () {
								var _p34 = element;
							...
							var offsetX = _p33._0;
							var offsetY = _p33._1;
							return A2(_user$project$Main$isSameElement, _p37.startPos, _p37.endPos) ? _elm_lang$core$Native_List.fromArray(
								[]) : _elm_lang$core$Native_List.fromArray(
								[
									{
									id: _p37.id,
									startPos: _p37.startPos,
									endPos: _user$project$Main$Offset(
										{ctor: '_Tuple3', _0: _p36, _1: offsetX, _2: offsetY}),
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							dragElement: _elm_lang$core$Maybe$Nothing,
							fcArrows: A2(_elm_lang$core$Basics_ops['++'], h, model.fcArrows),
							currentLine: _elm_lang$core$Maybe$Nothing
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
				...
				if (_p39.ctor === 'Nothing') {
					...
					var _p40 = _p39._0.areaType;
					if (_p40.ctor === 'Inner') {
						var m = A4(
							_user$project$Main$moveElementTo,
							model,
							model.dragElement,
							_elm_lang$core$Basics$toFloat(_p44.x) - model.dragOffsetX,
							_elm_lang$core$Basics$toFloat(_p44.y) - model.dragOffsetY);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							m,
							_elm_lang$core$Native_List.fromArray(
						...
						var element = A2(_user$project$Main$getElementWithId, model, _p39._0.id);
						var m = function () {
							var _p41 = element;
										...
										currentLine: A2(
											...
											function (_p42) {
												...
												return {
													ctor: '_Tuple2',
													_0: _p43._0,
													_1: _user$project$Main$Global(
														{
															ctor: '_Tuple2',
															_0: _elm_lang$core$Basics$toFloat(_p44.x),
															_1: _elm_lang$core$Basics$toFloat(_p44.y)
														})
												};
											},
											model.currentLine)
...
var _user$project$Main$fcShapeToSvg = F2(
	function (model, fcShape) {
		...
		var strokeColor = _elm_lang$core$Native_Utils.eq(model.selectedElement, fcShape.id) ? 'red' : outerColor;
		var _p45 = fcShape.shapeType;
		switch (_p45.ctor) {
			case 'Start':
				var _p46 = A3(_user$project$Main$getTextDimension, fcShape.title, 'Courier', 20);
				var textWidth = _p46._0;
				var textHeight = _p46._1;
			...
			case 'Action':
				var _p47 = A3(_user$project$Main$getTextDimension, fcShape.title, 'Courier', 20);
				var textWidth = _p47._0;
				var textHeight = _p47._1;
				var innerShapeWidth = (textWidth + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeWidth = (innerShapeWidth + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
				var innerShapeHeight = (textHeight + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeHeight = (innerShapeHeight + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
			...
			default:
				...
				var _p48 = A3(_user$project$Main$getTextDimension, fcShape.title, 'Courier', 20);
				var textWidth = _p48._0;
				var textHeight = _p48._1;
				var innerShapeWidth = (textWidth + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeWidth = (innerShapeWidth + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
				var innerShapeHeight = (textHeight + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeHeight = (innerShapeHeight + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
	...
	var cur = function () {
		...
		if (_p49.ctor === 'Nothing') {
			...
			return _elm_lang$core$Native_List.fromArray(
				[
					A2(
					_user$project$Main$fcArrowToSvg,
					model,
					{id: -1, startPos: _p49._0._0, endPos: _p49._0._1, title: 'no title'})
				]);
		}
	}();
	return A4(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$viewBox('0 0 8500 11500'),
				_elm_lang$svg$Svg_Attributes$width('8500'),
				_elm_lang$svg$Svg_Attributes$height('11500'),
				_elm_lang$svg$Svg_Attributes$pointerEvents('none')
			]),
		A2(
			_elm_lang$core$Basics_ops['++'],
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$svg$Svg_Attributes$id('arrowHead'),
									_elm_lang$svg$Svg_Attributes$markerWidth('15'),
