...
var _user$project$Main$getTextDimension = F3(
	function (text, font, fontSize) {
		var _p0 = font;
		if (_p0 === 'Courier') {
			return {
				ctor: '_Tuple2',
...
var _user$project$Main$getEndShapeId = function (arr) {
	var _p1 = arr.endPos;
...
var _user$project$Main$getStartShapeId = function (arr) {
	var _p2 = arr.startPos;
...
var _user$project$Main$arrowsWithEndShape = F2(
	function (model, id) {
		return A2(
...
var _user$project$Main$arrowsWithStartShape = F2(
	function (model, id) {
		return A2(
			_elm_lang$core$List$filter,
			function (x) {
				...
				if ((_p4.ctor === 'Offset') && (_p4._0.ctor === '_Tuple3')) {
					return _elm_lang$core$Native_Utils.eq(_p4._0._0, id);
				} else {
					return false;
				}
			},
...
var _user$project$Main$isSameElement = F2(
	function (pos1, pos2) {
		var _p5 = pos1;
		if ((_p5.ctor === 'Offset') && (_p5._0.ctor === '_Tuple3')) {
			var _p6 = pos2;
			if ((_p6.ctor === 'Offset') && (_p6._0.ctor === '_Tuple3')) {
				return _elm_lang$core$Native_Utils.eq(_p5._0._0, _p6._0._0);
			} else {
				return false;
			}
		} else {
...
var _user$project$Main$moveElementTo = F4(
	function (model, movingElement, x, y) {
		var _p7 = movingElement;
		if (_p7.ctor === 'Nothing') {
			...
			var newShapes = A2(
				_elm_lang$core$List$map,
				function (el) {
					return _elm_lang$core$Native_Utils.eq(el.id, _p8) ? _elm_lang$core$Native_Utils.update(
						el,
						{x: x, y: y}) : el;
				},
				model.fcShapes);
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					debugMsg: _elm_lang$core$Basics$toString(_p8),
					fcShapes: newShapes
				});
		}
	});
...
var _user$project$Main$removeSelectedElement = function (model) {
	return A2(
						...
						model,
						{
							...
							fcShapes: A2(
								...
								function (currentShape) {
									return !_elm_lang$core$Native_Utils.eq(currentShape.id, _p9._0.id);
								},
								model.fcShapes)
						});
				} else {
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							fcArrows: A2(
								_elm_lang$core$List$filter,
								function (a) {
									return !_elm_lang$core$Native_Utils.eq(a.id, _p9._0.id);
								},
								model.fcArrows)
						});
				}
...
var _user$project$Main$moveEndPosTo = F2(
	function (fcArrow, fcPos) {
		return A2(
			_elm_lang$core$Maybe$map,
			function (arrow) {
				return _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$moveStartPosTo = F2(
	function (fcArrow, fcPos) {
		return A2(
			_elm_lang$core$Maybe$map,
			function (arrow) {
...
var _user$project$Main$saveElements = function (model) {
	var toArrowObject = function (a) {
		var _p10 = function () {
			...
			if (_p11.ctor === 'Offset') {
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Json_Encode$int(_p11._0._0),
					_1: _p11._0._1,
					_2: _p11._0._2
				};
			} else {
				return {ctor: '_Tuple3', _0: _elm_lang$core$Json_Encode$null, _1: _p11._0._0, _2: _p11._0._1};
			}
		}();
		var destination_id = _p10._0;
		var destination_offset_x = _p10._1;
		var destination_offset_y = _p10._2;
		var _p12 = function () {
			var _p13 = a.startPos;
			if (_p13.ctor === 'Offset') {
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Json_Encode$int(_p13._0._0),
					_1: _p13._0._1,
					_2: _p13._0._2
				};
			} else {
				return {ctor: '_Tuple3', _0: _elm_lang$core$Json_Encode$null, _1: _p13._0._0, _2: _p13._0._1};
			}
		}();
		var source_id = _p12._0;
		var source_offset_x = _p12._1;
		var source_offset_y = _p12._2;
		return _elm_lang$core$Json_Encode$object(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					{ctor: '_Tuple2', _0: 'source_id', _1: source_id},
					{ctor: '_Tuple2', _0: 'destination_id', _1: destination_id},
					{
					ctor: '_Tuple2',
					_0: 'source_offset_x',
					_1: _elm_lang$core$Json_Encode$float(source_offset_x)
				},
					{
					ctor: '_Tuple2',
					_0: 'source_offset_y',
					_1: _elm_lang$core$Json_Encode$float(source_offset_y)
				},
					{
					ctor: '_Tuple2',
					_0: 'destination_offset_x',
					_1: _elm_lang$core$Json_Encode$float(destination_offset_x)
				},
					{
					ctor: '_Tuple2',
					_0: 'destination_offset_y',
					_1: _elm_lang$core$Json_Encode$float(destination_offset_y)
				},
					{
					ctor: '_Tuple2',
					_0: 'title',
					_1: _elm_lang$core$Json_Encode$string(a.title)
				}
				]));
	};
	var toShapeObject = function (s) {
		return _elm_lang$core$Json_Encode$object(
			_elm_lang$core$Native_List.fromArray(
				[
					{
					...
					_1: _elm_lang$core$Json_Encode$string(
						_elm_lang$core$Basics$toString(s.shapeType))
				},
					{
					ctor: '_Tuple2',
					_0: 'x',
					_1: _elm_lang$core$Json_Encode$float(s.x)
				},
					{
					ctor: '_Tuple2',
					_0: 'y',
					_1: _elm_lang$core$Json_Encode$float(s.y)
				},
					{
					ctor: '_Tuple2',
					_0: 'text',
					_1: _elm_lang$core$Json_Encode$string(s.text)
				},
					{
					ctor: '_Tuple2',
					_0: 'title',
					_1: _elm_lang$core$Json_Encode$string(s.title)
				}
				]));
	};
	var json = A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, toShapeObject, model.fcShapes))
				},
					{
					ctor: '_Tuple2',
					_0: 'arrows',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, toArrowObject, model.fcArrows))
				}
				])));
	return A2(
		...
		_evancz$elm_http$Http$defaultSettings,
		{
			...
			body: _evancz$elm_http$Http$multipart(
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_evancz$elm_http$Http$stringData, 'action', 'save'),
						A2(_evancz$elm_http$Http$stringData, 'flowchart', json)
					]))
		});
};
var _user$project$Main$removeShape = F2(
	function (model, id) {
		return model;
	});
var _user$project$Main$getId = function (fcElement) {
	var _p14 = fcElement;
	if (_p14.ctor === 'Shape') {
		return _p14._0.id;
	} else {
...
var _user$project$Main$getText = function (fcElement) {
	var _p15 = fcElement;
	if (_p15.ctor === 'Shape') {
		return _p15._0.text;
	} else {
...
var _user$project$Main$getTitle = function (fcElement) {
	var _p16 = fcElement;
	if (_p16.ctor === 'Shape') {
		return _p16._0.title;
	} else {
		return _p16._0.title;
	}
};
var _user$project$Main$findFreeId = function (l) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (el, state) {
				return (_elm_lang$core$Native_Utils.cmp(el.id, state) > -1) ? (el.id + 1) : state;
			}),
		1,
		l);
};
var _user$project$Main$getArrowWithId = F2(
	function (l, id) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (el) {
					return _elm_lang$core$Native_Utils.eq(el.id, id);
				},
				l));
	});
var _user$project$Main$getShapeWithId = F2(
	function (l, id) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
...
var _user$project$Main$outerPadding = 30.0;
var _user$project$Main$innerPadding = 20.0;
var _user$project$Main$myFontFamily = 'Courier';
var _user$project$Main$myFontSize = 20;
...
var _user$project$Main$FcShape = F6(
	function (a, b, c, d, e, f) {
		return {id: a, shapeType: b, x: c, y: d, text: e, title: f};
	});
var _user$project$Main$FcArrow = F5(
	function (a, b, c, d, e) {
		return {id: a, startPos: b, endPos: c, text: d, title: e};
	});
var _user$project$Main$ShapeArea = F2(
	function (a, b) {
		return {areaType: a, id: b};
	});
var _user$project$Main$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {fcShapes: a, fcArrows: b, debugMsg: c, dragElement: d, dragOffsetX: e, dragOffsetY: f, selectedElement: g, dragArrow: h, mainDivOffset: i};
	});
var _user$project$Main$Action = {ctor: 'Action'};
var _user$project$Main$Condition = {ctor: 'Condition'};
var _user$project$Main$End = {ctor: 'End'};
var _user$project$Main$Start = {ctor: 'Start'};
var _user$project$Main$readShapeType = function (s) {
	var _p17 = s;
	switch (_p17) {
		case 'Start':
			return _user$project$Main$Start;
		case 'End':
			return _user$project$Main$End;
		case 'Action':
			return _user$project$Main$Action;
		case 'Condition':
			return _user$project$Main$Condition;
		default:
			return _user$project$Main$End;
	}
};
var _user$project$Main$Global = function (a) {
	return {ctor: 'Global', _0: a};
};
var _user$project$Main$Offset = function (a) {
	return {ctor: 'Offset', _0: a};
};
var _user$project$Main$decodeElements = function () {
	var toFcArrow = A9(
		_elm_lang$core$Json_Decode$object8,
		F8(
			function (id, source_id, destination_id, source_offset_x, source_offset_y, destination_offset_x, destination_offset_y, title) {
				return {
					id: id,
					startPos: function () {
						var _p18 = source_id;
						if (_p18.ctor === 'Nothing') {
							return _user$project$Main$Global(
								{ctor: '_Tuple2', _0: source_offset_x, _1: source_offset_y});
						} else {
							return _user$project$Main$Offset(
								{ctor: '_Tuple3', _0: _p18._0, _1: source_offset_x, _2: source_offset_y});
						}
					}(),
					endPos: function () {
						var _p19 = destination_id;
						if (_p19.ctor === 'Nothing') {
							return _user$project$Main$Global(
								{ctor: '_Tuple2', _0: destination_offset_x, _1: destination_offset_y});
						} else {
							return _user$project$Main$Offset(
								{ctor: '_Tuple3', _0: _p19._0, _1: destination_offset_x, _2: destination_offset_y});
						}
					}(),
					text: '',
					title: title
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'source_offset_x', _elm_lang$core$Json_Decode$float),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'source_offset_y', _elm_lang$core$Json_Decode$float),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'destination_offset_x', _elm_lang$core$Json_Decode$float),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'destination_offset_y', _elm_lang$core$Json_Decode$float),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'title',
			_elm_lang$core$Json_Decode$oneOf(
	...
	var toFcShape = A7(
		...
		F6(
			function (id, x, y, shapeType, title, text) {
				return {id: id, x: x, y: y, shapeType: shapeType, title: title, text: text};
			}),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'x', _elm_lang$core$Json_Decode$float),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'y', _elm_lang$core$Json_Decode$float),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'shapeType',
			A2(_elm_lang$core$Json_Decode$object1, _user$project$Main$readShapeType, _elm_lang$core$Json_Decode$string)),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'title',
			_elm_lang$core$Json_Decode$oneOf(
	...
	return A3(
		...
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'fcShapes',
			_elm_lang$core$Json_Decode$list(toFcShape)),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'fcArrows',
			_elm_lang$core$Json_Decode$list(toFcArrow)));
}();
var _user$project$Main$loadElements = A3(
	_evancz$elm_http$Http$post,
	_user$project$Main$decodeElements,
	'http://localhost/elm/thousandDangers/src/db.php',
	_evancz$elm_http$Http$multipart(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_evancz$elm_http$Http$stringData, 'action', 'load')
			])));
var _user$project$Main$Inner = {ctor: 'Inner'};
var _user$project$Main$Outer = {ctor: 'Outer'};
var _user$project$Main$SelectArrowElement = function (a) {
	return {ctor: 'SelectArrowElement', _0: a};
};
var _user$project$Main$createHtml1 = F3(
	function (model, id, tries) {
		var mshape = A2(_user$project$Main$getShapeWithId, model.fcShapes, id);
		if (_elm_lang$core$Native_Utils.eq(tries, 1000)) {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		} else {
			var _p20 = mshape;
			if (_p20.ctor === 'Nothing') {
				...
				var _p24 = _p20._0;
				var arrows = A2(_user$project$Main$arrowsWithStartShape, model, id);
				var newIds = A2(
					_elm_lang$core$List$filterMap,
					function (x) {
						var _p21 = x.endPos;
						if ((_p21.ctor === 'Offset') && (_p21._0.ctor === '_Tuple3')) {
					...
					arrows);
				var _p22 = _p24.shapeType;
				if (_p22.ctor === 'Condition') {
					return A2(
						_elm_lang$core$List_ops['::'],
						A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$svg$Svg$text(_p24.text)
								])),
						A3(
							_elm_lang$core$List$foldl,
							F2(
								function (el, state) {
									var _p23 = el.endPos;
									if ((_p23.ctor === 'Offset') && (_p23._0.ctor === '_Tuple3')) {
										return A2(
											_elm_lang$core$List_ops['::'],
											A2(
												_elm_lang$html$Html$p,
													...
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																...
																_user$project$Main$SelectArrowElement(_p23._0._0))
															]),
														_elm_lang$core$Native_List.fromArray(
															[
					...
					return A2(
						...
						A3(
							_user$project$Main$createHtml1,
							model,
							A2(
								_elm_lang$core$Maybe$withDefault,
								-1,
...
var _user$project$Main$createHtml = F2(
	function (model, id) {
		return A3(_user$project$Main$createHtml1, model, id, 0);
	});
var _user$project$Main$fcArrowToSvg = F2(
	function (model, fcArrow) {
		var textOrientation = 'auto';
		var _p25 = function () {
			var _p26 = model.selectedElement;
			if ((_p26.ctor === 'Just') && (_p26._0.ctor === 'Arrow')) {
				return _elm_lang$core$Native_Utils.eq(_p26._0._0.id, fcArrow.id) ? {ctor: '_Tuple2', _0: 'red', _1: 1} : {ctor: '_Tuple2', _0: 'lightblue', _1: 0};
			} else {
				return {ctor: '_Tuple2', _0: 'lightblue', _1: 0};
			}
		}();
		var strokeColor = _p25._0;
		var mySelectStrokeWidth = _p25._1;
		var myStrokeWidth = 1;
		var _p27 = function () {
			var _p28 = fcArrow.endPos;
			if (_p28.ctor === 'Global') {
				return {ctor: '_Tuple2', _0: _p28._0._0, _1: _p28._0._1};
			} else {
				return A2(
					_elm_lang$core$Maybe$withDefault,
					...
					A2(
						_elm_lang$core$Maybe$map,
						function (e) {
							return {ctor: '_Tuple2', _0: _p28._0._1 + e.x, _1: _p28._0._2 + e.y};
						},
						A2(_user$project$Main$getShapeWithId, model.fcShapes, _p28._0._0)));
			}
		}();
		var endX = _p27._0;
		var endY = _p27._1;
		var _p29 = function () {
			var _p30 = fcArrow.startPos;
			if (_p30.ctor === 'Global') {
				return {ctor: '_Tuple2', _0: _p30._0._0, _1: _p30._0._1};
			} else {
				return A2(
					_elm_lang$core$Maybe$withDefault,
					{ctor: '_Tuple2', _0: 0, _1: 0},
					A2(
						_elm_lang$core$Maybe$map,
						function (e) {
							return {ctor: '_Tuple2', _0: _p30._0._1 + e.x, _1: _p30._0._2 + e.y};
						},
						A2(_user$project$Main$getShapeWithId, model.fcShapes, _p30._0._0)));
			}
		}();
		var startX = _p29._0;
		var startY = _p29._1;
		...
		var mt1 = (_elm_lang$core$Native_Utils.cmp(endX, startX) < 1) ? A2(
			_elm_lang$core$Basics_ops['++'],
			'scale(-1,-1) translate(',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString((2 * l) / 2),
				', 0)')) : 'translate(0, 0)';
		var myMarker = A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'arrowHead',
						_elm_lang$core$Basics$toString(fcArrow.id))),
					_elm_lang$svg$Svg_Attributes$markerWidth(
					_elm_lang$core$Basics$toString(l)),
					_elm_lang$svg$Svg_Attributes$markerHeight('12'),
					_elm_lang$svg$Svg_Attributes$overflow('visible'),
					_elm_lang$svg$Svg_Attributes$viewBox('-6, -6, 12, 12'),
					_elm_lang$svg$Svg_Attributes$refX('5'),
					_elm_lang$svg$Svg_Attributes$refY('0'),
					_elm_lang$svg$Svg_Attributes$orient(textOrientation)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$svg$Svg_Attributes$points('-2,0 -5,5 5,0 -5,-5'),
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$svg$Svg_Attributes$y('-6'),
									_elm_lang$svg$Svg_Attributes$x(
									_elm_lang$core$Basics$toString(0 - l)),
									_elm_lang$svg$Svg_Attributes$width(
									_elm_lang$core$Basics$toString(l + 6)),
									_elm_lang$svg$Svg_Attributes$height('12'),
									...
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(mySelectStrokeWidth),
											';stroke-dasharray:10,10;stroke:rgb(0, 0, 190);fill-opacity:0.0;')))
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$svg$Svg_Attributes$style('-ms-user-select: none; o-user-select: none; user-select: none; -webkit-user-select: none; -moz-user-select: none;'),
									_elm_lang$svg$Svg_Attributes$transform(mt1),
									_elm_lang$svg$Svg_Attributes$fontSize(
									_elm_lang$core$Basics$toString(_user$project$Main$myFontSize)),
									_elm_lang$svg$Svg_Attributes$fontFamily(_user$project$Main$myFontFamily),
									_elm_lang$svg$Svg_Attributes$x(
									_elm_lang$core$Basics$toString(
										((0 - l) / 2) - (_elm_lang$core$Basics$fst(
											A3(_user$project$Main$getTextDimension, fcArrow.title, _user$project$Main$myFontFamily, _user$project$Main$myFontSize)) / 2))),
									_elm_lang$svg$Svg_Attributes$y(
									_elm_lang$core$Basics$toString(-15)),
									_elm_lang$svg$Svg_Attributes$fill('blue')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$svg$Svg$text(fcArrow.title)
								]))
						]))
				]));
		var distance = 50 / myStrokeWidth;
		var _p31 = {ctor: '_Tuple2', _0: startX + ((endX - startX) * (distance / l)), _1: startY + ((endY - startY) * (distance / l))};
		var sx = _p31._0;
		var sy = _p31._1;
		var _p32 = (_elm_lang$core$Native_Utils.cmp(l, 2 * distance) < 1) ? {ctor: '_Tuple2', _0: sx, _1: sy} : {ctor: '_Tuple2', _0: endX - ((endX - startX) * (distance / l)), _1: endY - ((endY - startY) * (distance / l))};
		var ex = _p32._0;
		var ey = _p32._1;
		var t = A2(
			_elm_lang$svg$Svg$g,
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$svg$Svg_Attributes$markerEnd(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'url(#arrowHead',
								A2(
							...
							A2(
								...
								_elm_lang$core$Basics$toString(myStrokeWidth)))
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onClick(
							_user$project$Main$SelectArrowElement(fcArrow.id)),
							_elm_lang$svg$Svg_Attributes$d(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'M ',
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(14 * myStrokeWidth),
									';stroke-opacity:0.0001')))
						]),
					_elm_lang$core$Native_List.fromArray(
						[]))
				]));
		return {ctor: '_Tuple2', _0: t, _1: myMarker};
	});
var _user$project$Main$ScrollPositionTold = function (a) {
	return {ctor: 'ScrollPositionTold', _0: a};
};
var _user$project$Main$SetScrollPosition = function (a) {
	return {ctor: 'SetScrollPosition', _0: a};
};
var _user$project$Main$TextChanged = function (a) {
	return {ctor: 'TextChanged', _0: a};
};
var _user$project$Main$TitleChanged = function (a) {
	return {ctor: 'TitleChanged', _0: a};
};
var _user$project$Main$HttpFailure = function (a) {
	return {ctor: 'HttpFailure', _0: a};
};
var _user$project$Main$HttpSuccess = function (a) {
	return {ctor: 'HttpSuccess', _0: a};
};
var _user$project$Main$UpMsg = function (a) {
	return {ctor: 'UpMsg', _0: a};
};
var _user$project$Main$DownMsg = function (a) {
	return {ctor: 'DownMsg', _0: a};
};
var _user$project$Main$fcShapeToSvg = F2(
	function (model, fcShape) {
		var textColor = 'red';
		var innerColor = 'blue';
		var outerColor = '#FFF9CE';
		var strokeColor = function () {
			var _p33 = model.selectedElement;
			if ((_p33.ctor === 'Just') && (_p33._0.ctor === 'Shape')) {
				return _elm_lang$core$Native_Utils.eq(_p33._0._0.id, fcShape.id) ? 'red' : outerColor;
			} else {
				return outerColor;
			}
		}();
		var _p34 = fcShape.shapeType;
		switch (_p34.ctor) {
			case 'Start':
				var _p35 = A3(_user$project$Main$getTextDimension, fcShape.title, 'Courier', 20);
				var textWidth = _p35._0;
				var textHeight = _p35._1;
				var innerShapeWidth = (textWidth + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeWidth = (innerShapeWidth + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
				var innerShapeHeight = (textHeight + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeHeight = (innerShapeHeight + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
				return A2(
					_elm_lang$svg$Svg$g,
					_elm_lang$core$Native_List.fromArray(
						[
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_user$project$Main$DownMsg(
										{areaType: _user$project$Main$Outer, id: fcShape.id})),
									_elm_lang$svg$Svg_Events$onMouseUp(
									_user$project$Main$UpMsg(
										{areaType: _user$project$Main$Outer, id: fcShape.id})),
									_elm_lang$svg$Svg_Attributes$x(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$svg$Svg_Events$onMouseDown(
									_user$project$Main$DownMsg(
										{areaType: _user$project$Main$Inner, id: fcShape.id})),
									_elm_lang$svg$Svg_Events$onMouseUp(
									_user$project$Main$UpMsg(
										{areaType: _user$project$Main$Inner, id: fcShape.id})),
									_elm_lang$svg$Svg_Attributes$x(
									_elm_lang$core$Basics$toString(fcShape.x + _user$project$Main$outerPadding)),
									_elm_lang$svg$Svg_Attributes$y(
									_elm_lang$core$Basics$toString(fcShape.y + _user$project$Main$outerPadding)),
									_elm_lang$svg$Svg_Attributes$style('-ms-user-select: none; -o-user-select: none; user-select: none; -webkit-user-select: none; -moz-user-select: none;'),
									_elm_lang$svg$Svg_Attributes$width(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$svg$Svg_Attributes$cursor('default'),
									_elm_lang$svg$Svg_Attributes$x(
									_elm_lang$core$Basics$toString((fcShape.x + _user$project$Main$outerPadding) + _user$project$Main$innerPadding)),
									_elm_lang$svg$Svg_Attributes$y(
									_elm_lang$core$Basics$toString((((fcShape.y + _user$project$Main$outerPadding) + _user$project$Main$innerPadding) + (textHeight / 2)) + (_user$project$Main$myFontSize / 3))),
			...
			case 'Action':
				var _p36 = A3(_user$project$Main$getTextDimension, fcShape.title, 'Courier', 20);
				var textWidth = _p36._0;
				var textHeight = _p36._1;
				var innerShapeWidth = (textWidth + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeWidth = (innerShapeWidth + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
				var innerShapeHeight = (textHeight + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeHeight = (innerShapeHeight + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
			...
			case 'End':
				var _p37 = A3(_user$project$Main$getTextDimension, fcShape.title, 'Courier', 20);
				var textWidth = _p37._0;
				var textHeight = _p37._1;
				var innerShapeWidth = (textWidth + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeWidth = (innerShapeWidth + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
				var innerShapeHeight = (textHeight + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeHeight = (innerShapeHeight + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
			...
			default:
				var innerStartY = fcShape.y + _user$project$Main$outerPadding;
				var innerStartX = fcShape.x + _user$project$Main$outerPadding;
				var _p38 = A3(_user$project$Main$getTextDimension, fcShape.title, 'Courier', 20);
				var textWidth = _p38._0;
				var textHeight = _p38._1;
				var innerShapeWidth = (textWidth + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeWidth = (innerShapeWidth + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
				var innerShapeHeight = (textHeight + _user$project$Main$innerPadding) + _user$project$Main$innerPadding;
				var outerShapeHeight = (innerShapeHeight + _user$project$Main$outerPadding) + _user$project$Main$outerPadding;
	...
	var cur = A2(
		...
		A2(
			...
			function (x) {
				return _elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$Main$fcArrowToSvg, model, x)
					]);
			},
			model.dragArrow));
	var allArrows = A2(
		...
		A2(
			_elm_lang$core$List$map,
			_user$project$Main$fcArrowToSvg(model),
			model.fcArrows));
	var _p39 = _elm_lang$core$List$unzip(allArrows);
	var arrowSvgs = _p39._0;
	var arrowHeads = _p39._1;
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('mainEl'),
						...
						A2(
							_elm_lang$core$Json_Decode$map,
							function (keyCode) {
								return _user$project$Main$KeyMsg(keyCode);
							},
						...
						_elm_lang$core$Json_Decode$succeed(
							_user$project$Main$SetScrollPosition('mainEl'))),
						_elm_lang$html$Html_Attributes$style(
						_elm_lang$core$Native_List.fromArray(
							[
					...
					[
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$List$map,
									_user$project$Main$fcShapeToSvg(model),
									model.fcShapes),
								arrowSvgs)))
					])),
				A2(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														A2(
															_elm_lang$core$Maybe$withDefault,
															'',
															A2(_elm_lang$core$Maybe$map, _user$project$Main$getTitle, model.selectedElement))),
														_elm_lang$html$Html_Events$onInput(_user$project$Main$TitleChanged)
													]),
												_elm_lang$core$Native_List.fromArray(
													[]))
											]))
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														A2(
															_elm_lang$core$Maybe$withDefault,
															'',
															A2(_elm_lang$core$Maybe$map, _user$project$Main$getText, model.selectedElement))),
														_elm_lang$html$Html_Events$onInput(_user$project$Main$TextChanged)
													]),
												_elm_lang$core$Native_List.fromArray(
													[]))
											]))
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Maybe$map,
									function (x) {
										return _user$project$Main$getId(x);
									},
									model.selectedElement))))
					]))
			]));
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$scrollPositionTold(_user$project$Main$ScrollPositionTold),
				_elm_lang$mouse$Mouse$moves(_user$project$Main$MouseMove),
				_elm_lang$mouse$Mouse$ups(_user$project$Main$MouseUp),
				_elm_lang$mouse$Mouse$downs(_user$project$Main$MouseDown)
			]));
};
var _user$project$Main$Shape = function (a) {
	return {ctor: 'Shape', _0: a};
};
var _user$project$Main$Arrow = function (a) {
...
var _user$project$Main$init = {
	...
	_0: {
		fcShapes: _elm_lang$core$Native_List.fromArray(
			[
				{id: 1, shapeType: _user$project$Main$Start, x: 40, y: 90, text: 'abc', title: '1'},
				{id: 2, shapeType: _user$project$Main$Action, x: 40, y: 490, text: 'def', title: 'tre2'}
			]),
		fcArrows: _elm_lang$core$Native_List.fromArray(
			[
				{
				id: 1,
				startPos: _user$project$Main$Offset(
					{ctor: '_Tuple3', _0: 1, _1: 10, _2: 40}),
				endPos: _user$project$Main$Offset(
				...
				{
				id: 2,
				startPos: _user$project$Main$Global(
					{ctor: '_Tuple2', _0: 190, _1: 50}),
				endPos: _user$project$Main$Global(
		...
		dragArrow: _elm_lang$core$Maybe$Nothing,
		mainDivOffset: {x: 0.0, y: 0.0}
	},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Main$setTitle = F2(
	function (fcElement, title) {
		var _p40 = fcElement;
		if (_p40.ctor === 'Shape') {
			return _user$project$Main$Shape(
				_elm_lang$core$Native_Utils.update(
					_p40._0,
					{title: title}));
		} else {
			return _user$project$Main$Arrow(
				_elm_lang$core$Native_Utils.update(
					_p40._0,
					{title: title}));
		}
	});
var _user$project$Main$setText = F2(
	function (fcElement, text) {
		var _p41 = fcElement;
		if (_p41.ctor === 'Shape') {
			return _user$project$Main$Shape(
				_elm_lang$core$Native_Utils.update(
	...
	function (msg, model) {
		...
		switch (_p42.ctor) {
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								dragElement: _elm_lang$core$Maybe$Just(
									{areaType: _p44, id: _p45}),
								selectedElement: A2(
									_elm_lang$core$Maybe$map,
									_user$project$Main$Shape,
									A2(_user$project$Main$getShapeWithId, model.fcShapes, _p45)),
								dragArrow: _elm_lang$core$Maybe$Nothing
							}),
						_elm_lang$core$Native_List.fromArray(
							[]));
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								...
								selectedElement: A2(
									...
									_user$project$Main$Shape,
									A2(_user$project$Main$getShapeWithId, model.fcShapes, _p45)),
								dragArrow: _elm_lang$core$Maybe$Just(
									{
										id: _user$project$Main$findFreeId(model.fcArrows),
										startPos: _user$project$Main$Offset(
											{ctor: '_Tuple3', _0: _p45, _1: 0, _2: 0}),
										endPos: _user$project$Main$Offset(
											{ctor: '_Tuple3', _0: _p45, _1: 0, _2: 0}),
										text: 'dfas',
										title: 'adsdsfa'
			...
			case 'MouseDown':
				var _p51 = _p42._0;
				var id = function () {
					var _p46 = model.dragElement;
					if (_p46.ctor === 'Nothing') {
						return _elm_lang$core$Maybe$Nothing;
					} else {
						return _elm_lang$core$Maybe$Just(_p46._0.id);
					}
				}();
				var shapePos = A2(
					_elm_lang$core$Maybe$map,
					_user$project$Main$getShapeWithId(model.fcShapes),
					id);
				var pos = A2(
					...
					model.mainDivOffset);
				var _p47 = shapePos;
				if ((_p47.ctor === 'Just') && (_p47._0.ctor === 'Just')) {
					var _p50 = _p47._0._0;
					var offsetY = pos.y - _p50.y;
					var offsetX = pos.x - _p50.x;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								...
								dragArrow: A2(
									_elm_lang$core$Maybe$map,
									function (line) {
										var _p48 = line.startPos;
										if ((_p48.ctor === 'Offset') && (_p48._0.ctor === '_Tuple3')) {
											var _p49 = _p48._0._0;
											return _elm_lang$core$Native_Utils.update(
												line,
												{
													startPos: _user$project$Main$Offset(
														{ctor: '_Tuple3', _0: _p49, _1: offsetX, _2: offsetY}),
													endPos: _user$project$Main$Offset(
														{ctor: '_Tuple3', _0: _p49, _1: offsetX, _2: offsetY})
												});
										} else {
				...
				switch (_p52) {
								...
								model,
								{
									...
									fcShapes: A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												{
												id: _user$project$Main$findFreeId(model.fcShapes),
												shapeType: _user$project$Main$Start,
												x: 400.0,
												y: 400.0,
												text: 'Start',
												title: 'Start'
					...
					case 66:
						var x = A3(
							...
							function (a) {
								return _user$project$Main$HttpFailure(
									_elm_lang$core$Basics$toString(a));
							},
							function (a) {
								return _user$project$Main$HttpSuccess(a);
							},
							_user$project$Main$loadElements);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
					...
					case 67:
						var x = A3(
							...
							_user$project$Main$saveElements(model));
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
					...
					case 46:
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_user$project$Main$removeSelectedElement(model),
							_elm_lang$core$Native_List.fromArray(
								[]));
					default:
						return A2(
			...
			case 'SetScrollPosition':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Main$getScrollPosition(_p42._0)
						]));
			case 'ScrollPositionTold':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{mainDivOffset: _p42._0}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'SelectArrowElement':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							selectedElement: A2(
								_elm_lang$core$Maybe$map,
								_user$project$Main$Arrow,
								A2(_user$project$Main$getArrowWithId, model.fcArrows, _p42._0))
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'HttpSuccess':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							fcShapes: _elm_lang$core$Basics$fst(_p53),
							fcArrows: _elm_lang$core$Basics$snd(_p53)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'HttpFailure':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							debugMsg: A2(_elm_lang$core$Basics_ops['++'], 'HttpFailure ', _p42._0)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'TitleChanged':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							dragElement: _elm_lang$core$Maybe$Nothing,
							dragArrow: A2(
								_user$project$Main$moveEndPosTo,
								model.dragArrow,
								_user$project$Main$Offset(
									{ctor: '_Tuple3', _0: _p42._0.id, _1: 0, _2: 0}))
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'MouseUp':
				...
				var pos = A2(
					_user$project$Main$localToGlobal,
					{
						x: _elm_lang$core$Basics$toFloat(_p57.x),
						y: _elm_lang$core$Basics$toFloat(_p57.y)
					},
					model.mainDivOffset);
				var newArrow = A2(
					...
					A2(
						...
						A2(
							...
							function (a) {
								var _p54 = a.endPos;
								if ((_p54.ctor === 'Offset') && (_p54._0.ctor === '_Tuple3')) {
									var _p55 = _p54._0._0;
									return A2(
										_elm_lang$core$Maybe$withDefault,
										_elm_lang$core$Native_List.fromArray(
										...
										A2(
											_elm_lang$core$Maybe$map,
											function (el) {
												return A2(_user$project$Main$isSameElement, a.startPos, a.endPos) ? _elm_lang$core$Native_List.fromArray(
													[]) : _elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$core$Native_Utils.update(
														a,
														{
															endPos: _user$project$Main$Offset(
																{ctor: '_Tuple3', _0: _p55, _1: pos.x - el.x, _2: pos.y - el.y})
														})
													]);
											},
											A2(_user$project$Main$getShapeWithId, model.fcShapes, _p55)));
								} else {
									return _elm_lang$core$Native_List.fromArray(
										[]);
								}
				...
				var _p56 = A2(
					_elm_lang$core$Debug$log,
					'arrows',
					A2(_elm_lang$core$Basics_ops['++'], newArrow, model.fcArrows));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							dragElement: _elm_lang$core$Maybe$Nothing,
							fcArrows: A2(_elm_lang$core$Basics_ops['++'], newArrow, model.fcArrows),
							dragArrow: _elm_lang$core$Maybe$Nothing
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
				var _p61 = _p42._0;
				var _p58 = A2(_elm_lang$core$Debug$log, 'selected ', model.selectedElement);
				var pos = A2(
					_user$project$Main$localToGlobal,
					{
						x: _elm_lang$core$Basics$toFloat(_p61.x),
						y: _elm_lang$core$Basics$toFloat(_p61.y)
					},
					model.mainDivOffset);
				var _p59 = model.dragElement;
										...
										return _elm_lang$core$Native_Utils.update(
											model,
											{
												dragArrow: A2(
													_user$project$Main$moveEndPosTo,
													model.dragArrow,
													_user$project$Main$Global(
														{ctor: '_Tuple2', _0: pos.x, _1: pos.y}))
											});
									},
									A2(_user$project$Main$getShapeWithId, model.fcShapes, _p59._0.id))),
							_elm_lang$core$Native_List.fromArray(
								[]));
					}
				}
